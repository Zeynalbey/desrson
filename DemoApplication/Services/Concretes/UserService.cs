...
namespace DemoApplication.Services.Abstracts
{
    public class UserService : IUserService
    {
            ...
            IHttpContextAccessor httpContextAccessor)
        {
            ...
            IsOk = _httpContextAccessor.HttpContext!.User.Identity!.IsAuthenticated;
        }
        ...
        public async Task<bool> CheckPasswordAsync(string? email, string? password)
        {
            ...
            if (model is not null || BCrypt.Net.BCrypt.Verify(password, model!.Password))
            {
                return true;
            }
            return false;
        ...
        public async Task CreateAsync(RegisterViewModel model)
        {
            ...
            async Task<User> CreateUserAsync(RegisterViewModel model)
            {
                var user = new User
                {
